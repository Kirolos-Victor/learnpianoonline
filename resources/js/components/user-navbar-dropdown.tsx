    ...
    return (
        <div className="relative inline-block text-left">
            <button
                ...
                className="inline-flex items-center gap-2 rounded-md bg-background px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-gray-300 hover:bg-gray-50 focus:ring-2 focus:ring-navy-600 focus:outline-none"
                aria-haspopup="true"
                aria-expanded={open}
            >
                <span
                    className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-gray-200 text-gray-600">

    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-gray-50">
            <Head>
                ...
                <meta
                    name="description"
                    content="The page you're looking for doesn't exist. Return to our homepage to continue your piano learning journey."
                />
            ...
            <div className="text-center">
                ...
                <Link href="/" className="cursor-pointer text-blue-500 underline hover:text-blue-700">
                    Return to Home
                </Link>
            </div>
        </div>

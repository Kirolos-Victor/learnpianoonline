...
const StudentLessons = ({ student, lessons, availableMonths, filters }: Props) => {
    ...
    const handleFilterChange = () => {
        router.get(
            route('instructor.student.lessons', student.slug),
            {
    ...
    return (
        <InstructorLayout title={`${student.name} - Lessons`}>
            <Head title={`${student.name} - Lessons - Instructor Panel`} />
                ...
                <CardContent>
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div>
                            ...
                            <p className="font-medium">{student.sessions_remaining}</p>
                        </div>
                        <div>
                                ...
                                <div className="mt-6 flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-2">
                                        {lessons.current_page > 1 && (
                                            <Link
                                                href={route('instructor.student.lessons', student.slug)}
                                                data={{
                                                    ...Object.fromEntries(
                                                        Object.entries({
                                                            month: month !== 'all' ? month : undefined,

                                                ...
                                                <div className="rounded-lg border border-blue-200 bg-blue-50 p-3">
                                                    <div className="mb-2 flex items-center">
                                                        ...
                                                        <span className="text-sm font-medium text-blue-800">
                                                            Feedback from {submission.instructor}
                                                        </span>
                                                    </div>
                            ...
                            <Card className="border-green-200 bg-green-50">
                                ...
                                <CardContent>
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex items-center justify-between">
                                            <span className="text-sm text-green-700">Average Feedback Score</span>
                                            <span className="font-semibold text-green-800">8.5/10</span>
                                        </div>
                                        <div className="flex items-center justify-between">
                                            <span className="text-sm text-green-700">Current Streak</span>
                                            <span className="font-semibold text-green-800">7 weeks</span>
                                        </div>
                                    </div>
                                </CardContent>
                            </Card>

...
const PendingSubscribers = ({ students, instructors, filters }: Props) => {
    ...
    const applyFilters = () => {
        router.get('/admin/pending-subscribers', {
            search: searchTerm,
    ...
    const handleAssignInstructor = () => {
        ...
        setProcessing(true);
        router.patch(`/admin/pending-subscribers/${selectedStudent.id}/assign-instructor`, {
    ...
    return (
        <AdminLayout title="Pending Subscribers">
            ...
            <div className="mb-8">
                ...
                <p className="text-gray-600 mt-2">Subscribed students waiting for instructor assignment</p>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Subscribed students who need instructor assignment
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    {students.data.length === 0 ? (
                        ...
                        <>
                            ...
                            <div className="mt-6">
                                <TablePagination
                                    data={students}
                                    onPageChange={(page) => router.get(`/admin/pending-subscribers?page=${page}`, {
                                        search: searchTerm,
                                        per_page: filters.per_page,
                                    }, { preserveState: true, replace: true })}
                                    onPerPageChange={(perPage) => router.get('/admin/pending-subscribers', {
                                        search: searchTerm,
                                        per_page: perPage,
                                    }, { preserveState: true, replace: true })}
                                />
